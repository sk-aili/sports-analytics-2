...
class ModelRegistryClient:
    ...
    def update_model_version(self, name, version, description, model_framework):
        """
        ...
        return self.store.update_model_version(
            name=name, version=version, description=description, model_framework=model_framework
        )
