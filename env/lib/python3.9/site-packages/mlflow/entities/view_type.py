...
class ViewType:
    ...
    def to_proto(cls, view_type):
        ...
        elif view_type == cls.HARD_DELETED_ONLY:
            return service_pb2.HARD_DELETED_ONLY
    ...
    def from_proto(cls, proto_view_type):
        if proto_view_type == service_pb2.ACTIVE_ONLY:
            ...
            return cls.ALL
        elif proto_view_type == service_pb2.HARD_DELETED_ONLY:
            return cls.HARD_DELETED_ONLY
