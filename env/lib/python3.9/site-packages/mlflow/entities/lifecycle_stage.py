...
class LifecycleStage:
    ...
    def view_type_to_stages(cls, view_type=ViewType.ALL):
        ...
        if view_type == ViewType.HARD_DELETED_ONLY:
            stages.append(cls.HARD_DELETED)
        return stages
    ...
    def matches_view_type(cls, view_type, lifecycle_stage):
        ...
        elif view_type == ViewType.HARD_DELETED_ONLY:
            return lifecycle_stage == LifecycleStage.HARD_DELETED
        else:
