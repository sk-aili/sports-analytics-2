...
class ListUserApiKeys(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """ListUserApiKeys - a model defined in OpenAPI

        Args:
            items ([UserApiKey]): A list of all known API key metadata
