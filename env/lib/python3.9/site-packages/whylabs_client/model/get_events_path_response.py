...
def lazy_import():
    ...
    globals()['EventsPath'] = EventsPath


class GetEventsPathResponse(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """GetEventsPathResponse - a model defined in OpenAPI

        Args:
            items ([EventsPath]): A list of events
