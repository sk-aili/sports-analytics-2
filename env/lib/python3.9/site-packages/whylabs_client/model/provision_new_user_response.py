...
class ProvisionNewUserResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, org_id, model_id, *args, **kwargs):  # noqa: E501
        """ProvisionNewUserResponse - a model defined in OpenAPI
